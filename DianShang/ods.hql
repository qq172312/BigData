...
load data inpath '/origin_data/gmall/db/user_info_inc/2022-06-08'
into table ods_user_info_inc partition(dt='2022-06-09');

select * from ods_log_inc where ts<1654695110235;

select page.item,page.item_type from ods_log_inc where `page`.item_type='sku_id';
...
load data inpath '/origin_data/gmall/db/ods_order_detail_inc/2022-06-08'
    into table ods_order_detail_inc partition(dt='2022-06-08');

msck repair table ods_order_detail_inc sync partitions;
